...
public class Gatec extends AppCompatActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        (this.db = FirebaseDatabase.getInstance().getReference("gate4")).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                Gatec.this.datachanged(dataSnapshot);
            }
        });
    }
}
