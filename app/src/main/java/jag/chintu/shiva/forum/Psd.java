...
public class Psd extends AppCompatActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        (this.db = FirebaseDatabase.getInstance().getReference("psd")).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                Psd.this.datachanged(dataSnapshot);
            }
        });
    }
}
