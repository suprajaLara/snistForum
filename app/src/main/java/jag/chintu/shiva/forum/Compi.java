...
public class Compi extends AppCompatActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        (this.db = FirebaseDatabase.getInstance().getReference("compi")).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                Compi.this.datachanged(dataSnapshot);
            }
        });
    }
}
