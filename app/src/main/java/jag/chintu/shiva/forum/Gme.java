...
public class Gme extends AppCompatActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        (this.db = FirebaseDatabase.getInstance().getReference("gme")).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                Gme.this.datachanged(dataSnapshot);
            }
        });
    }
}
