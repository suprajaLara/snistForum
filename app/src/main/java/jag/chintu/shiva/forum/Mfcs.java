...
public class Mfcs extends AppCompatActivity
{
    ...
    protected void onCreate(final Bundle bundle) {
        ...
        (this.db = FirebaseDatabase.getInstance().getReference("mfcs")).addValueEventListener(new ValueEventListener() {
            @Override
            ...
            public void onDataChange(final DataSnapshot dataSnapshot) {
                Mfcs.this.datachanged(dataSnapshot);
            }
        });
    }
}
