...
public class Mechyears extends AppCompatActivity
{
    ...
    public void intiative() {
        ...
        recyclerView.addOnItemTouchListener((RecyclerView.OnItemTouchListener)new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Mechyears.this.getApplicationContext(), (GestureDetector.OnGestureListener)new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(final RecyclerView recyclerView, final MotionEvent motionEvent) {
                ...
                if (childViewUnder != null && this.gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (childAdapterPosition == 0) {
                        Mechyears.this.startActivity(new Intent((Context)Mechyears.this, (Class)Cse1sub.class));
                    }
                    if (childAdapterPosition == 1) {
                        Mechyears.this.startActivity(new Intent((Context)Mechyears.this, (Class)Mech2sub.class));
                    }
                    if (childAdapterPosition == 2) {
                        Mechyears.this.startActivity(new Intent((Context)Mechyears.this, (Class)Mech3sub.class));
                    }
                    if (childAdapterPosition == 3) {
                        Mechyears.this.startActivity(new Intent((Context)Mechyears.this, (Class)Mech4sub.class));
                    }
                }
                return false;
            }
