...
public class Ecmyears extends AppCompatActivity
{
    ...
    public void intiative() {
        ...
        recyclerView.addOnItemTouchListener((RecyclerView.OnItemTouchListener)new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Ecmyears.this.getApplicationContext(), (GestureDetector.OnGestureListener)new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(final RecyclerView recyclerView, final MotionEvent motionEvent) {
                ...
                if (childViewUnder != null && this.gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (childAdapterPosition == 0) {
                        Ecmyears.this.startActivity(new Intent((Context)Ecmyears.this, (Class)Cse1sub.class));
                    }
                    if (childAdapterPosition == 1) {
                        Ecmyears.this.startActivity(new Intent((Context)Ecmyears.this, (Class)Ecm2sub.class));
                    }
                    if (childAdapterPosition == 2) {
                        Ecmyears.this.startActivity(new Intent((Context)Ecmyears.this, (Class)Ecm3sub.class));
                    }
                    if (childAdapterPosition == 3) {
                        Ecmyears.this.startActivity(new Intent((Context)Ecmyears.this, (Class)Ecm4sub.class));
                    }
                }
                return false;
            }
