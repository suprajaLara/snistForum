...
public class Eeeyears extends AppCompatActivity
{
    ...
    public void intiative() {
        ...
        recyclerView.addOnItemTouchListener((RecyclerView.OnItemTouchListener)new RecyclerView.OnItemTouchListener() {
            GestureDetector gestureDetector = new GestureDetector(Eeeyears.this.getApplicationContext(), (GestureDetector.OnGestureListener)new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onInterceptTouchEvent(final RecyclerView recyclerView, final MotionEvent motionEvent) {
                ...
                if (childViewUnder != null && this.gestureDetector.onTouchEvent(motionEvent)) {
                    ...
                    if (childAdapterPosition == 0) {
                        Eeeyears.this.startActivity(new Intent((Context)Eeeyears.this, (Class)Cse1sub.class));
                    }
                    if (childAdapterPosition == 1) {
                        Eeeyears.this.startActivity(new Intent((Context)Eeeyears.this, (Class)Eee2sub.class));
                    }
                    if (childAdapterPosition == 2) {
                        Eeeyears.this.startActivity(new Intent((Context)Eeeyears.this, (Class)Eee3sub.class));
                    }
                    if (childAdapterPosition == 3) {
                        Eeeyears.this.startActivity(new Intent((Context)Eeeyears.this, (Class)Eee4sub.class));
                    }
                }
                return false;
            }
